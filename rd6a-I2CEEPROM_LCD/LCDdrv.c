 ...
 * PARAMETERS:      None
 * RETURN VALUE:    None
 * NOTES:           This interface is implemented on an Cerebot MX7cK processor
 *                  board and uses the PIC32 PMP bus.
 * END DESCRIPTION *****************************************************/
void initLCD(void)
{
 ...
 * PARAMETERS:      charter pointer - to text string
 * RETURN VALUE:    None
 ...
 *                  CR (Carriage return) places cursor at the 1st of first line
